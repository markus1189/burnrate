...
requestyFixture = object
  [ "provider" .= ("requesty" :: String)
  , "self" .= object
      [ "name" .= ("agent" :: String), "monthly_spend" .= ("83.38" :: String)
      , "monthly_limit" .= ("150" :: String), "group" .= object ["id" .= ("g1" :: String)] ]
  , "usage" .= object
      ["usage" .= object ["2026-08-03" .= object ["spend" .= ("5.5" :: String)]]] ]

orLimitFixture = object
  [ "provider" .= ("openrouter" :: String)
  , "key" .= object ["data" .= object
      [ "label" .= ("or" :: String), "usage_monthly" .= (42.5 :: Double)
      , "limit" .= (100 :: Double), "limit_reset" .= ("monthly" :: String)
      , "limit_remaining" .= (57.5 :: Double) ]]
  , "credits" .= object [] ]

orBalanceFixture = object
  [ "provider" .= ("openrouter" :: String)
  , "key" .= object ["data" .= object
      [ "label" .= ("t" :: String), "usage_monthly" .= (6.0 :: Double)
      , "limit" .= (Nothing :: Maybe Double) ]]
  , "credits" .= object ["data" .= object
